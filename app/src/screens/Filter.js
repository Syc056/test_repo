...
// // // //                       <div
// // // //                           className="choose-photo-item-3cut-top-line"
// // // //                           style={{ backgroundImage: `url(${process.env.REACT_APP_BACKEND}/serve_photo/${encodeURIComponent(photos[selectedPhotos[0]].url.split('/').pop())})`, filter: getImageStyle() }}
// // // //                       />
// // // //                   </div>
// // // //               )
// // // //               const selectedPhotoRows = chunkArray(selectedPhotos.slice(1), 2);
...
// // // //                           <div
// // // //                               className="choose-photo-item-5cut-last-line"
// // // //                               style={{ backgroundImage: `url(${process.env.REACT_APP_BACKEND}/serve_photo/${encodeURIComponent(photos[selectedPhotos[selectedPhotos.length - 1]].url.split('/').pop())})`, filter: getImageStyle() }}
// // // //                           />
// // // //                       </div>
// // // //                   )
// // // //                   const selectedPhotoRows = chunkArray(selectedPhotos.slice(0, selectedPhotos.length - 1), 2);
...
// // //      const displayClassNameForPhoto = (rowIndex, photoIndex) => {
// // //           console.log("sel frame",selectedFrame)
// // //           if (selectedFrame === 'Stripx2') {
// // //                if (rowIndex === 0 && photoIndex === 0) {
// // //                     return 'choose-photo-item-0-0';
// // //                } else if (rowIndex === 0 && photoIndex === 1) {
...
// // //                           {row.map((selectedIndex, photoIndex) =>
// // //                              {
// // //                               console.log("rowIndex,photoIndex",rowIndex,photoIndex)
// // //                               return <div
// // //                                   key={photoIndex}
// // //                                   className={displayClassNameForPhoto(rowIndex, photoIndex)}
// // //                                   style={{ 
...
// // //      storeImageCanvas()
// // // },[])
// // // console.log("background in filter>>>",myBackground)
// // //      return (
// // //           <div className='filter-container' style={{ backgroundImage: `url(${background})`, cursor: 'none' }}>
// // //                <div className="go-back" style={{ backgroundImage: `url(${goBackButton})` }} onClick={() => navigate("/photo-choose")} onMouseEnter={() => hoverGoBackButton()} onMouseLeave={() => hoverGoBackButton()}></div>
// // //                <div className="left-big-frame">
...
// //      const increasePercentage = () => {
// //           console.log("플러스 클릭클릭",percentage,filterEffect)
// //           setSliderChange(true);
// //           if (percentage < 570) {
// //                setPercentage(percentage + 10);
// //           }
...
function Filter() {
     ...
     useEffect(() => {
          ...
          console.log("copied photo>>>",layoutData)
          if (layoutData) {
...
//      storeImageCanvas()
// },[])
console.log("myBackground in filter>>>",myBackground)
     return (
          <div className='filter-container' style={{ backgroundImage: `url(${background})`
          // , cursor: 'none'
           }}>
