...
// photos 설정 부분
useEffect(() => {
     const photosData = JSON.parse(sessionStorage.getItem('photos'));
     if (photosData === null) return;
     setPhotos(photosData.images); // images 배열로 설정
...
//      console.log("photos")
//      console.log(photos)
//      const selItems = photos.images.filter((item, index) => selectedPhotos.includes(index));
                              ...
                              {group.map((mySticker, photoIndex) => (
                                   <div
                                        ...
                                        onClick={() => {
                                             ...
                                             src: mySticker.photo,
                                             width: 100,
                                             ...adjustStickerToBackgroundSize(width,height,30, 30, 200, 200) // 스티커의 초기 위치와 크기를 지정
                                             });
